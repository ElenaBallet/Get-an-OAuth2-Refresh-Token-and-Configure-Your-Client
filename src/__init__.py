...
creds = {"google_ads": dir_path + "/creds/google-ads.yaml"}


if not os.path.isfile(creds["google_ads"]):
    raise FileExistsError("File doesn't exists. Please create folder creds and put google-ads.yaml file there. ")
